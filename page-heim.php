    ...
    <?php if ($image && !empty($service_categories[$index])): ?>
        <div class="service-item">
            ...
            <div class="overlay">
                ...
                <?php if ($index == 0): ?>
                    <a href="<?php echo esc_url(home_url('/waschkuche')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php elseif ($index == 1): ?>
                    <a href="<?php echo esc_url(home_url('/sanfte-losung')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php elseif ($index == 2): ?>
                    <a href="<?php echo esc_url(home_url('/kontaktieren-sie-un')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
