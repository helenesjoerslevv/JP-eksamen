...
<section class="hero-home">
    ...
    <div class="hero-home-content">
        ...
        <a href="vaske-ydelser" class="btn btn-primary"><?php pll_e("Se vores ydelser")?></a>
    </div>
</section>
            ...
            <?php if ($image && !empty($service_categories[$index])): ?>
                <div class="service-item">
                    ...
                    <div class="overlay">
                        ...
                        <?php elseif ($index == 1): ?>
                            <a href="<?php echo esc_url(home_url('/skaansom-loesning')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                        <?php elseif ($index == 2): ?>
